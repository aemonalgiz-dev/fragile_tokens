...
echo "#### 7b. Qwen3.8-Flash-Next-FP8 rung (v4, 56GiB/card cap), N_TOK=8400, chat framing, teacher-forced only  ($(date -u +%H:%M:%S))" | tee -a logs/scale.log
...
echo "QWEN38 FLASH DONE2 $(date -u)" | tee -a logs/scale.log
